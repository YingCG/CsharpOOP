...
namespace WindowsFormsSandwichStore
{
    class StoreDb
    {
        ...
        public StoreDb()
        {
            var settings = MongoClientSettings.FromConnectionString("mongodb+srv://curious-earthworm:xxwQDpTmhQm9R6jI@byo-cup-corner.sqa3qxz.mongodb.net/?retryWrites=true&w=majority");
