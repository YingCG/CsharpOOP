...
namespace WindowsFormsSandwichStore
{
    class StoreDb
    {
        ...
        public StoreDb()
        {
            var settings = MongoClientSettings.FromConnectionString("mongodb+srv://curious-earthworm:hT4HYjBcZlsWs7Lf@byo-cup-corner.sqa3qxz.mongodb.net/?retryWrites=true&w=majority");
